...
import { DistributorRequestForm } from '../../components/Distributor/Manager/DistributorRequestForm';
import { DistributorRequestHistory } from '../../components/Distributor/Manager/DistributorRequestHistory';
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Request products from Head Office for distribution.</p>
        </div>
        <button
