...
import { DRRequestForm } from '../../components/DirectRepresentative/DRRequestForm';
import { DRRequestHistory } from '../../components/DirectRepresentative/DRRequestHistory';
import { Plus } from 'lucide-react';

export function DRRequests() {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Request products from Head Office for your shops.</p>
        </div>
        <button
